...
if (run_on == "humans") {
  data_dir = "C:/Users/maria/MEGAsync/Berkeley/TaskSets/Data/version3.1"  # version3.1  # versions1.0and3.1  # version1.0  # versionEEG
  patt = ".*csv"
  ...
  patt = "aliens_Bayes.*csv"  # "alien_..csv" -> subjID1-9, "alien_...csv" -> subjID10-99, "alien_....csv" -> subjID100-999
...
if (substr(data_dir, 55, 58) != "1.0") {
  ...
  # Tests
  hist(mixed_block_l_sum_wide$RT_diff)
