...
parameter_names = c("alpha", "alpha_high", "beta", "beta_high", "epsilon", "forget", "create_TS_biased")
if (run_on == "humans") {
  ...
  patt = "sim_rec_....csv"  # "alien_..csv" -> subjID1-9, "alien_...csv" -> subjID10-99, "alien_....csv" -> subjID100-999
...
parameter_long = merge(parameter_long_gen, parameter_long_rec)
...
parameter_long
gg_gen_rec = ggplot(subset(parameter_long, gen_par != 0), aes(gen_par, rec_par, color = subjID)) +
  geom_point() +
  geom_abline(slope = 1, linetype = "dotted") +
  theme(legend.position = "none") +
  facet_wrap(model_name ~ parameter, scale = "free")

if (gg_save) {
  ggsave(file.path(plot_dir, "7gg_gen_rec.png"), gg_gen_rec, width = 6, height = 3 * length(unique(parameter_dat$model_name)))
}
```
