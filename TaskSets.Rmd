...
rainbow_sum_l$item_value_obj[rainbow_sum_l$TS == 0] = mean(c(6, 5, 4))
rainbow_sum_l$item_value_obj[rainbow_sum_l$TS == 1] = mean(c(3, 7, 8))
...
gg_values =
  ggplot(subset(subjwise_regr_coefs, predictor %in% interesting_predictors), aes(phase, Estimate, color = phase, alpha = `Pr(>|z|)` < 0.05)) +
  # geom_violin() +
