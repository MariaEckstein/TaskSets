...
value_plot = value_plot + aes(fill = sad_alien) + labs(x = "TS", fill = "Alien")
value_plot + facet_wrap(~ paste("Subj", subjID))
...
value_plot + labs(title = "True underlying TS")
```
...
ggplot(subset(pick_aliens, subjID < 20), aes(trial_index, value_chosen - value_unchosen, color = assess)) +
  geom_point() +
