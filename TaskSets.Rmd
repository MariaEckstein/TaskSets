...
subset(feed_aliens, phase == "5RainbowSeason")
...
missed_trials = ddply(subset(feed_aliens, phase == "5RainbowSeason" & is.na(key)),
                       ...
                       summarize,
                       times_chosen = sum(is.na(key)))  # number of missed trials
...
gg_subj_strategy = ggplot(rainbow_sum_l, aes(orderedSubj, Ratio, fill = TS)) +
  geom_bar(stat = "identity") +
  labs(x = "", fill = "") +
  geom_hline(yintercept = 18/16, linetype = "dotted") +
  theme(axis.text.x = element_blank())

gg_subj_strategy2 = gg_subj_strategy + aes(x = orderedSubj2) + labs(x = "")

gg_strategy_hist = ggplot(rainbow_sum_l, aes(Ratio, fill = TS)) +
  geom_histogram(stat = "density", position = "identity", alpha = 0.5) +
  geom_vline(xintercept = 3/16, linetype = "dotted") +
  geom_vline(xintercept = 2/16, linetype = "dotted", color = "red") +
  labs(fill = "")
...
gg_overlap = ggplot(overlapping_choices, aes(times_chosen, fill = item_chosen)) +
  geom_histogram(binwidth = 1) +
  geom_vline(xintercept = 1, linetype = "dotted") +
  labs(x = "Times chosen", y = "Count", fill = "Item")

if (gg_save) {
  ggsave(file.path(plot_dir, "5gg_rainbow_strategy.png"), gg_rainbow_strategy, width = 3, height = 3)
  ...
  ggsave(file.path(plot_dir, "5gg_overlap.png"), gg_overlap, width = 4, height = 3)
}
```
