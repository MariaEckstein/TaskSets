...
gg_rainbow_strategy = ggplot(rainbow_sum_l, aes(TS, times_chosen / 12, fill = TS)) + 
...
gg_strategy_hist = ggplot(subset(rainbow_sum_l, TS %in% c("TS0", "TS1", "TS2", "None")), aes(times_chosen / 12, fill = TS)) +
  geom_histogram(stat = "density", position = "identity", alpha = 0.5) +
  labs(x = "Fraction", fill = "")
