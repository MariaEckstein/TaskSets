...
regr_dat = subset(feed_aliens, phase != "0Training", select = c("subjID", "phase", "sad_alien", "TS", "reward", "TS_value_subj", "TS_value_obj", "item_value_subj", "item_value_obj", "alien_trial_sum", "alien_trial", "repetition", "ACC", "model_name"))#, "trial"
...
if (gg_save) {
  ...
  ggsave(file.path(plot_dir, "/2gg_otherTS_ACC4.png"), gg_otherTS_ACC4, width = 3, height = 10)
...
if (run_regression) {
  # for (model_name in unique(regr_dat$model_name))
  for (phas in feed_aliens_phases) {
...
if (gg_save) {
  ggsave(file.path(plot_dir, "/6gg_alpha_values.png"), gg_alpha_values, width = 10, height = 10)
  ggsave(file.path(plot_dir, "/6gg_beta_values.png"), gg_beta_values, width = 10, height = 10)
}
```
```{r Start button}
```