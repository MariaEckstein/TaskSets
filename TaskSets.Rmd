...
parameter_names = c("alpha", "beta", "forget")  # , "alpha_high", "beta_high", 'TS_bias', "epsilon"
if (run_on == "humans") {
  ...
  patt = "alien"  # "alien_..csv" -> subjID1-9, "alien_...csv" -> subjID10-99, "alien_....csv" -> subjID100-999
