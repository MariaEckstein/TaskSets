...
subset(others, select = c("subjID", "trial_index", "sad_alien", "item_chosen", "ACC_TS", "ACC", "current_TS"))
subset(dat_l, select = c("subjID", "trial_index", "sad_alien", "item_chosen", "ACC_TS", "ACC", "current_TS"))
unique(dat_l$ACC_TS)
subset(dat_l, ACC_TS == "ACCNone")
```
