...
run_on = "gen_rec"  # can be "fitted_humans", "gen_rec", "humans", or "simulations"
gg_save = T
run_regression = F
...
parameter_names = c("alpha", "alpha_high", "beta", "beta_high", "epsilon", "forget", 'create_TS_biased_prefer_new', 'create_TS_biased_copy_old')# , "create_TS_biased")  #
if (run_on == "humans") {
  data_dir = "C:/Users/maria/MEGAsync/Berkeley/TaskSets/Data/version3.1"
  patt = "1...csv"
} else if (run_on == "simulations") {
  data_dir = "C:/Users/maria/MEGAsync/Berkeley/TaskSets/AlienGenRec/MaxInsteadOfSoftmax/"
  patt = "sim_2...csv"  # "alien_..csv" -> subjID1-9, "alien_...csv" -> subjID10-99, "alien_....csv" -> subjID100-999
...
if (run_on == "gen_rec") {
  ...
  gg_gr =
    ...
    facet_wrap(model_name ~ parameter, scale = "free", ncol = length(unique(parameter_long$parameter)))
  gg_gen_rec = gg_gen_rec + geom_abline(slope = 0, linetype = "dotted")
  gg_gen_rec2 = gg_gen_rec + aes(y = rec_par) + geom_abline(slope = 1, linetype = "dotted")
