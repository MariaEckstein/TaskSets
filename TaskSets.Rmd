...
for (phas in c("1InitialLearning", "2CloudySeason")) {
  ...
  gg_otherTS_ACC = ggplot(dat_l, aes(alien_trial, 100 * ACC, color = ACC_TS)) +
    stat_summary(fun.data = mean_se, geom = "pointrange") +
    geom_hline(yintercept = 100/3, linetype = "dotted") +
  ...
  if (gg_save) {
    ...
    ggsave(paste(plot_dir, "/2gg_prevTS_ACC_", phas, ".png", sep = ""), gg_prevTS_ACC, width = 9, height = 3)
  }
}
```
