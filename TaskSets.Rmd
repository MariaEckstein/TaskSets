...
n_aliens = 4
data_dir = "C:/Users/maria/MEGAsync/Berkeley/TaskSets/Data/17-10-03"
...
comb_dat = merge(correct_values,
                 subset(rainbow, item_chosen != "NaN"),
                 by = c("subjID", "sad_alien", "TS", "item_chosen"), all = T)
comb_dat

# Plot OPTIMAL CHOICES in every season together with subject's choices in the rainbow season
ggplot(comb_dat, aes(sad_alien, item_chosen, color = TS)) +
  geom_point() +
