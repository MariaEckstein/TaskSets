...
var aliens =
  "<center><div class='alien_box'>" +
    "<img class='alien' src='/static/img/" + pr_alien_names[0] + ".png'>" +
    "<img class='alien' src='/static/img/" + pr_alien_names[1] + ".png'>" +
    "<img class='alien' src='/static/img/" + pr_alien_names[2] + ".png'>" +
    "<img class='alien' src='/static/img/" + pr_alien_names[3] + ".png'>" +
  "</div></center>"
...
/* reward_bubble = "<div>" +
    "<img class='bubble' src='/static/img/speech.png'>" +
    "<p class='reward'> +5" +
  "</div>" */

reward_ruler = "<div>" +
    "<img class='ruler' src='/static/img/measuringtape_5cm.png' style='top: 98%'>" +
    //"<p class='reward'>" +
    "</div>"
...
happy_aliens =
  "<center><div class='alien_box'>" +
    "<div>" +
      "<img class='alien' src='/static/img/" + pr_alien_names[0] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 15%'>" +
      "<img class='alien' src='/static/img/" + pr_alien_names[1] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 50%'>" +
    "</div><div>" +
      "<img class='alien' src='/static/img/" + pr_alien_names[2] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 15%'>" +
      "<img class='alien' src='/static/img/" + pr_alien_names[3] + ".png'>" +
...
instructions2 = "<center><p>The aliens' planet goes through different seasons, " +
  ...
  "<div class='alien_box'>" +
    "<img class='season' src='/static/img/hot.png'>" +
    "<img class='season' src='/static/img/cold.png'>" +
    "<img class='season' src='/static/img/rainy.png'>" +
  "</div>" +
...
happy_aliens =
  "<center><div class='alien_box'>" +
    "<div>" +
      "<img class='alien' src='/static/img/" + ph1_alien_names[0] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 15%'>" +
      "<img class='alien' src='/static/img/" + ph1_alien_names[1] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 50%'>" +
    "</div><div>" +
      "<img class='alien' src='/static/img/" + ph1_alien_names[2] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 15%'>" +
      "<img class='alien' src='/static/img/" + ph1_alien_names[3] + ".png'>" +
      "<img class='lovebubble' src='/static/img/happy2.png' style='left: 50%'>" +
    "</div>" +
  "</div></center>"
